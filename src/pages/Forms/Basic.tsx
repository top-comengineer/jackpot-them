            ...
            <form>
              <div>
                <input
                  ...
                  className="form-input mb-2"
                />
                <span className="badge bg-primary block text-xs hover:top-0">
                  I am the helper text.
                </span>
              </div>
            </form>
          ...
          <div className="mb-5">
            <form className="space-y-5">
              ...
              <div>
                ...
                <select
                  id="disSelect"
                  className="form-select disabled:pointer-events-none disabled:bg-[#eee] dark:disabled:bg-[#1b2e4b] text-white-dark"
                  disabled
                >
                  <option>Open this select menu</option>
                  <option>One</option>
            ...
            <form>
              <div>
                <select
                  size={4}
                  multiple
                  className="form-multiselect text-white-dark !bg-none"
                >
                  <option>Open this select menu</option>
                  <option>One</option>
                  <option>Two</option>
